...
export class Pipeline extends Stack {
    constructor(scope: Construct, id: string, props: StackConfiguration) {
        ...
        const pipeline = new CodePipeline(this, 'Pipeline', {
            pipelineName: `cdk-v2-service-${props.stageName}`,
            synth: new ShellStep('Synth', {
                input: CodePipelineSource.codeCommit(Repository.fromRepositoryName(this, 'CodeRepository', 'cdk-v2-service'), props.branchName),
                installCommands: [
